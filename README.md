...
2. Download the `hide-Elo-1.2.c` file anywhere.
...
5. Type `gcc hideElo-1.2.c -o hideElo-1.2.exe` and press enter. This should generate the .exe file. It should be about 70 kilobytes (very small!).
6. Either double click the executable to run it, or in the same terminal window as before, type "./hideElo-1.2.exe". The latter will let you see the debug output of the mod.
