/* ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ */
/* COMPATIBLE WITH Rivals of Aether II version 11-19-2024-12500 - [release] */
/* ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ */
// Compile with:
// gcc hideElo-1.1.c -o hideElo-1.1.exe
...
int main(){
	...
	TogglePatch(
		...
		process, moduleBase, 0x4E3716D, 4,
		// Original:
		/* jnl Rivals2-Win64-Shipping.exe+4E37172 */"\x7D\x03"\
		/* mov al,01 */							 "\xB0\x01",
		// Patch:
		/* nop (2 bytes) */						 "\x66\x90"\
		/* mov al 07 */							 "\xB0\x07"
	...
	TogglePatch(
		...
		process, moduleBase, 0x4E37202, 4,
		// Original:
		/* jnl Rivals2-Win64-Shipping.exe+4E37207 */"\x7D\x03"\
		/* mov al,01 */							 "\xB0\x01",
		// Patch:
		/* nop (2 bytes) */						 "\x66\x90"\
		/* mov al 07 */							 "\xB0\x07"
	...
	TogglePatch(
		...
		process, moduleBase, 0x4E37270, 5,
		// Original:
		/* call Rivals2-Win64-Shipping.exe+1229440 */"\xE8\xCB\x21\x3F\xFC",
		// Patch:
	...
	TogglePatch(
		...
		process, moduleBase, 0x4DEA228, 5,
		// Original:
		/* call Rivals2-Win64-Shipping.exe+4DDC1F0 */"\xE8\xC3\x1F\xFF\xFF",
		// Patch:
		/* nop (5 bytes) */						  "\x0F\x1F\x44\x00\x01"
	);
