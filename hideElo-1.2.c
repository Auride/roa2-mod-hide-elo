/* ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ */
/* COMPATIBLE WITH Rivals of Aether II version 11-19-2024-12519 - [release] */
/* ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ */
// Compile with:
// gcc hideElo-1.2.c -o hideElo-1.2.exe
...
int main(){
	...
	TogglePatch(
		...
		process, moduleBase, 0x4E36CDD, 4,
		// Original:
		/* jnl Rivals2-Win64-Shipping.exe+4E36CE2 */"\x7D\x03"\
		/* mov al,01 */                             "\xB0\x01",
		// Patch:
		/* nop (2 bytes) */                         "\x66\x90"
		/* mov al 07 */                             "\xB0\x07"
	...
	TogglePatch(
		...
		process, moduleBase, 0x4E36D72, 4,
		// Original:
		/* jnl Rivals2-Win64-Shipping.exe+4E36D77 */"\x7D\x03"\
		/* mov al,01 */                             "\xB0\x01",
		// Patch:
		/* nop (2 bytes) */                         "\x66\x90"\
		/* mov al 07 */                             "\xB0\x07"
	...
	TogglePatch(
		...
		process, moduleBase, 0x4E36DE0, 5,
		// Original:
		/* call Rivals2-Win64-Shipping.exe+1229440 */"\xE8\x5B\x26\x3F\xFC",
		// Patch:
	...
	TogglePatch(
		...
		process, moduleBase, 0x4DE9D98, 5,
		// Original:
		/* call Rivals2-Win64-Shipping.exe+4DDBE30 */"\xE8\x93\x20\xFF\xFF",
		// Patch:
		/* nop (5 bytes) */                          "\x0F\x1F\x44\x00\x01"
	);
