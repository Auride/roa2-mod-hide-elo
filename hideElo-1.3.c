/* ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ */
/* COMPATIBLE WITH Rivals of Aether II version 11-20-2024-12562 - [release] */
/* ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ */
// Compile with:
// gcc hideElo-1.3.c -o hideElo-1.3.exe
...
int main(){
	...
	TogglePatch(
		...
		process, moduleBase, 0x4E36C5D, 4,
		// Original:
		/* jnl Rivals2-Win64-Shipping.exe+4E36C62 */"\x7D\x03"\
		/* mov al,01 */                             "\xB0\x01",
		// Patch:
		/* nop (2 bytes) */                         "\x66\x90"
		/* mov al 07 */                             "\xB0\x07"
	...
	TogglePatch(
		...
		process, moduleBase, 0x4E36CF2, 4,
		// Original:
		/* jnl Rivals2-Win64-Shipping.exe+4E36CF7 */"\x7D\x03"\
		/* mov al,01 */                             "\xB0\x01",
		// Patch:
		/* nop (2 bytes) */                         "\x66\x90"\
		/* mov al 07 */                             "\xB0\x07"
	...
	TogglePatch(
		...
		process, moduleBase, 0x4E36D60, 5,
		// Original:
		/* call Rivals2-Win64-Shipping.exe+1229440 */"\xE8\xDB\x26\x3F\xFC",
		// Patch:
	...
	TogglePatch(
		...
		process, moduleBase, 0x4DE9E18, 5,
		// Original:
		/* call Rivals2-Win64-Shipping.exe+4DDBEB0 */"\xE8\x93\x20\xFF\xFF",
		// Patch:
		/* nop (5 bytes) */                          "\x0F\x1F\x44\x00\x01"
	);
