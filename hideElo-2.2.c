/* ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ */
/* COMPATIBLE WITH Rivals of Aether II version 1.1.4 -                      */
/* 03-05-2025 - 15726 - [release]                                           */
/* ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ */
// Compile with:
// gcc hideElo-2.2.c -o hideElo-2.2.exe
...
int main() {
	...
	aobInject(
		...
		// "7C 37 8B 81 98 00 00 00 3B 41 60 7D 03 B0 01 C3", +0x0B, // Pre-1.1.3
		// "7C 3D 8B 81 A8 00 00 00 3B 41 70 7D 03 B0 01 C3", +0x0B, // 1.1.3
        // "7C 3D 8B 81 C0 00 00 00 3B 41 70 7D 03 B0 01 C3", +0x0B, // 1.1.4
		   "7C ?? 8B 81 ?? 00 00 00 3B 41 ?? 7D 03 B0 01 C3", +0x0B,
		/* nop (2 bytes) */"\x66\x90"\
		/* mov al 07 */    "\xB0\x07", 4
	);
	...
	aobInject(
		...
		process, modBase, modEnd,
		// "7C 31 3B 51 60 7D 03 B0 01 C3", +0x05, // Pre-1.1.3
		// "7C 37 3B 51 70 7D 03 B0 01 C3", +0x05, // 1.1.3
		// "7C 37 3B 51 70 7D 03 B0 01 C3", +0x05, // 1.1.4
		   "7C ?? 3B 51 ?? 7D 03 B0 01 C3", +0x05,
		/* nop (2 bytes) */"\x66\x90"\
		/* mov al 07 */    "\xB0\x07", 4
	);
	...
	aobInject(
		...
		process, modBase, modEnd,
		// "80 B9 88 00 00 00 00 48 8B FA", +0x26, // Pre-1.1.3
		// "80 B9 98 00 00 00 00 48 8B FA", +0x26, // 1.1.3
		// "80 B9 B0 00 00 00 00 48 8B FA 74 4D", +0x26, // 1.1.4
           "80 B9 ?? 00 00 00 00 48 8B FA 74 4D", +0x26,
	...
	aobInject(
		...
		process, modBase, modEnd,
		"80 7B 50 00 74 0B 41 8B D7 48 8B CE ?? ?? ?? ?? ?? 48 8B 07", +0x20, // Unchanged through 1.1.4
		/* nop (5 bytes) */"\x0F\x1F\x44\x00\x01", 5
	);
